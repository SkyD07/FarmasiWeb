...
<main id="main" class="main">
    ...
    <button type="button" class="btn b-prnt mb-3" data-bs-toggle="modal" data-bs-target="#addAcc">
    ...
    <div class="card-detail">
        <div class="card-hdetail">
            <ul class="nav nav-tabs">
                <li class="nav-ditem">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-apoteker">Data Apoteker</button>
                </li>
                <li class="nav-ditem">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-dokter">Data Dokter</button>
                </li>
            </ul>
        </div>
        ...
        <div class="card-bdetail">
            ...
            <div class="tab-content pt-2">
                <div class="tab-pane fade show active profile-apoteker pt-3" id="profile-apoteker">
                ...
                <div class="tab-pane fade show profile-dokter pt-3" id="profile-dokter">
                    <table class="table table-striped mt-3">
                        <thead>
                            <tr>
