                            ...
                            <div class="d-flex align-items-center">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data as $d)
                                        <tr>
                                            <th scope="row"><a href="/timer-obat-pasien-{{ $d->slug }}" class="psn_dtl">
                                                {{ $d->name }}
                                            </a><br>
                                                <div class="u_name">
                                                    {{ $d->user->username }}
                                            ...
                                            <td>
                                                <?php
                                                    if ($d['status'] == "0") {
                                                        echo '<div class="u-j">
                                                                <span class="u-jadwal">Belum Terjadwal</span> </div>';
                                                    }
                                                ?>
                                            </td>
                                        </tr>
        ...
        <div class="row">
            ...
            <div class="col">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body px-0">
                  <h5 class="title-dash">Penjadwalan Check-Up Ulang Pasien</h5>
