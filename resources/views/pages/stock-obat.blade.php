...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="input-icons">
        ...
        <input class="form-control input-field mt-3" id="searchbar" onkeyup="search_obat()" type="text" name="search" placeholder="Cari Data Obat.. " style="width: 50%">
    </div>
