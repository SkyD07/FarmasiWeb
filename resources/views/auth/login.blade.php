                        ...
                        <div class="card-auth">
                            ...
                            <div class="card-body login-body">
                                    ...
                                    <form action="{{ route('login') }}" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input name="password" type="password" id="password" class="input-login form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" placeholder="Password" :value="old('password')" required>
